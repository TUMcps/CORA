function priv_generateConstraintEquations(scenario,powVariables)
% priv_generateConstraintEquations - generates the constraint equations of a 
...
% create file
priv_createFileFromFunction(g,[scenario.name,'_con'],'g','x,y,u');
