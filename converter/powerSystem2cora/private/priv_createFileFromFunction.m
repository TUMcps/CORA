function priv_createFileFromFunction(f,name,output,input)
% priv_createFileFromFunction - generates an m-file of a specified function
%
% Syntax:
%    priv_createFileFromFunction(f,name,output,input)
%
% Inputs:
%    f - function
