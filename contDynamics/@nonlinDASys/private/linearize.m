function [nlnsysDA,linsys,linParams,linOptions] = linearize(nlnsysDA,R,R_y,params,options)
% linearize - linearizes the nonlinear differential algebraic system;
%    linearization error is not included (see linError)
%
% Syntax:
%    [nlnsysDA,linsys,linParams,linOptions] = linearize(nlnsysDA,R,R_y,params,options)
%
% Inputs:
