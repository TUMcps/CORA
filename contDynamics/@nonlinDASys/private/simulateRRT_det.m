function [X_full,xTraj] = simulateRRT_det(nlnsysDA,Rcont,params,options)
% simulateRRT_det - simulates a DAE system using rapidly exploring random
%    trees (partially deterministic sampling)
%
% Syntax:
%    [X_full,xTraj] = simulateRRT_det(nlnsysDA,Rcont,params,options)
%
% Inputs:
