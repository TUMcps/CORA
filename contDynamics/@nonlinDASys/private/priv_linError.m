function [Z_error,errorInt,errorInt_x,errorInt_y,R_y] = priv_linError(nlnsysDA,options,R,Verror_y)
% priv_linError - computes the linearization error
%
% Syntax:
%    [Z_error,errorInt,errorInt_x,errorInt_y,R_y] = priv_linError(nlnsysDA,options)
%
% Inputs:
