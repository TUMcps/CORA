function [params_new,fval,p_opt,union_y_a] = priv_conform_white(sys,params,options)
% priv_conform_white - specific conformance synthesis method for nonlinear 
...
con = priv_conform_whiteCon(sys, testSuite, p_GO, G_X0, G_U, options.cs, union_y_a);
