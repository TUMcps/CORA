function Rint = priv_observe_intersectionMethod_I(sys,R,y,options)
% priv_observe_intersectionMethod_I - intersects the reachable set with
%    measurement strips according to intersection method I in [1]. 
%
% Syntax:
%    Rint = priv_observe_intersectionMethod_I(sys,R,y,options)
%
% Inputs:
