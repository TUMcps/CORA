function [res,R,failedDim] = isconform_BF(sys,params,options)
% isconform_BF - performs a conformance check using a white-box and test
...
%
% Syntax:
%    [res,R,failedDim] = isconform_BF(sys,params,options)
%
% Inputs:
