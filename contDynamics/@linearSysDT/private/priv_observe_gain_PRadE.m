function [OGain,tComp] = priv_observe_gain_PRadE(linsysDT,params,options)
% priv_observe_gain_PRadE - computes the gain for the guaranteed state estimation
%    approach from [1].
%
% Syntax:
%    [OGain,tComp] = priv_observe_gain_PRadE(linsysDT,params,options)
%
% Inputs:
