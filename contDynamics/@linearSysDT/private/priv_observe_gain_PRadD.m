function [OGain,tComp]= priv_observe_gain_PRadD(linsysDT,params,options)
% priv_observe_gain_PRadD - computes the gain for the guaranteed state estimation
%    approach from [1].
%
% Syntax:
%    [OGain,tComp]= priv_observe_gain_PRadD(linsysDT,params,options)
%
% Inputs:
