function [N, d, E] = priv_conform_reachableHalfspaces(linsysDT,params,options)
% priv_conform_reachableHalfspaces - computes reachable halfspaces according to 
%    [1]. This is not realized by first computing reach() becasue only the 
%    difference to the nominal solution is required.
%
% Syntax:
%    res = priv_conform_reachableHalfspaces(linsysDT,params,options)
%
% Inputs:
