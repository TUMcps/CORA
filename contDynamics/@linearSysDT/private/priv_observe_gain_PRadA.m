function [OGain, tComp] = priv_observe_gain_PRadA(linsysDT,params,options)
% priv_observe_gain_PRadA - computes the gain for the guaranteed state estimation
% approach according to Sec. 4.1 of [1].
%
% Syntax:
%    [R,Rout] = priv_observe_gain_PRadA(linsysDT,params,options)
%
% Inputs:
...
for i = 1:nrOfOutputs
    ...
    OGain(:,i) = priv_observe_gain_PRadB(linsysDT,params,options);
end
