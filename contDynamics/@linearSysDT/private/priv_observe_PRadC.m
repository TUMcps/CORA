function [R,tcomp] = priv_observe_PRadC(linsysDT,params,options)
% priv_observe_PRadC - computes the guaranteed state estimation approach
...
OGain = priv_observe_gain_PRadC(linsysDT,params,options);
