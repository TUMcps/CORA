function [OGain,tComp]= priv_observe_gain_PRadC(linsysDT,params,options)
% priv_observe_gain_PRadC - computes the gain for the guaranteed state estimation
%    approach from [1] and [2].
%
% Syntax:
%    [OGain,tComp] = priv_observe_gain_PRadC(linsysDT,params,options)
%
% Inputs:
