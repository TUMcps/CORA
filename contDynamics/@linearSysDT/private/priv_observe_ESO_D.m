function [R,tcomp] = priv_observe_ESO_D(linsysDT,params,options)
% priv_observe_ESO_D - computes the guaranteed state estimation approach of [1].
%
% Syntax:
...
[L,P,gamma,lambda] = priv_observe_gain_ESO_D(linsysDT,params,options);
