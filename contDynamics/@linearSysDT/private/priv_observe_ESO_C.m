function [R,tcomp] = priv_observe_ESO_C(linsysDT,params,options)
% priv_observe_ESO_C - computes the guaranteed state estimation approach of [1].
%
% Syntax:
...
[L,P,gamma,lambda] = priv_observe_gain_ESO_C(linsysDT,params,options);
