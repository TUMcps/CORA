function [R,tcomp] = priv_observe_FRadB(linsysDT,params,options)
% priv_observe_FRadB - computes the guaranteed state estimation approach
%    from [1].
%
% Syntax:
%    [R,Rout] = priv_observe_FRadB(linsysDT,params,options)
%
% Inputs:
