function [OGain,P,gamma,lambda,tComp] = priv_observe_gain_ESO_D(linsysDT,params,options)
% priv_observe_gain_ESO_D - computes the gain for the guaranteed state
%    estimation approach from [1]. 
%
% Syntax:
%    [OGain,P,gamma,lambda,tComp] = priv_observe_gain_ESO_D(linsysDT,params,options)
%
% Inputs:
