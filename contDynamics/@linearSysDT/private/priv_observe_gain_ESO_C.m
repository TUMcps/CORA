function [OGain,P,gamma,lambda,tComp] = priv_observe_gain_ESO_C(linsysDT,params,options)
% priv_observe_gain_ESO_C - computes the gain for the guaranteed state estimation
%    approach from [1]. 
%
% Syntax:
%    [OGain,tComp]= priv_observe_gain_ESO_C(linsysDT,params,options)
%
% Inputs:
