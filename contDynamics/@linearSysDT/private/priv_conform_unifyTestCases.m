function [union_y_a, union_x_a] = priv_conform_unifyTestCases(linsysDT,params)
% priv_conform_unifyTestCases - unifies test cases according to Sec. III.B in 
%    [1] and Sec. IV.C in [2].
%
% Syntax:
%    res = priv_conform_unifyTestCases(linsysDT,params,options)
%
% Inputs:
