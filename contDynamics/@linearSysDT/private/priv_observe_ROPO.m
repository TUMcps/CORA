function [R,tcomp] = priv_observe_ROPO(linsysDT,options)
% priv_observe_ROPO - computes the guaranteed state estimation approach
%    according to the set membership approach, see [1]. This is a strip
%    method.
%
% Syntax:
%    [R,tcomp] = priv_observe_ROPO(linsysDT,options)
%
% Inputs:
