function [Rin,Rout] = priv_reachInnerParallelotope(nlnsys,params,options)
% priv_reachInnerParallelotope - compute an inner-approximation of the reachable 
%    set using the algorithm in [1].
%
% Syntax:
%    [Rin,Rout] = priv_reachInnerParallelotope(nlnsys,options)
%
% Inputs:
