function obj = priv_highOrderMappingMatrix(obj,intermediateTerms)
% priv_highOrderMappingMatrix - computes a mapping matrix set without the first
%    two orders
%
% Syntax:
%    obj = priv_highOrderMappingMatrix(obj,intermediateTerms)
%
% Inputs:
...
eZ = zeros(obj.nrOfDims);
eZ_input = zeros(obj.nrOfDims);
...
eI = zeros(obj.nrOfDims);
eI_input = zeros(obj.nrOfDims);
