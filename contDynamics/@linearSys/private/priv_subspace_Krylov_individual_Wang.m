function [V,H,krylovOrder] = priv_subspace_Krylov_individual_Wang(A,nu_A,v,initKrylovOrder,options)
% priv_subspace_Krylov_individual_Wang - computes the Krylov subspace for a
...
%
% Syntax:
%    [V,H,KrylovOrder] = priv_subspace_Krylov_individual_Wang(A,nu_A,v,initKrylovOrder,options)
%
% Inputs:
%    A - system matrix
