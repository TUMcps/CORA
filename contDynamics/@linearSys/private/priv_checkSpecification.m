function [res,YtimeInt,YtimePoint] = priv_checkSpecification(spec,XtimeInt,YtimeInt,YtimePoint,idx)
...
%
% Syntax:
%    [res,timeInt,timePoint] = priv_checkSpecification(spec,timeInt,timePoint,idx)
%
% Inputs:
