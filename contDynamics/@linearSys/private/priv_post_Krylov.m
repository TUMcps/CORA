function [Rnext,options] = priv_post_Krylov(linsys,params,options)
% priv_post_Krylov - computes the reachable continuous set for one time step in 
%    the Krylov subspace
%
% Syntax:
...
[R_hom_tp_proj,R_Krylov_proj] = priv_exponential_Krylov_projected(linsys,params.R0,options,1);
[RV_proj,R_V_Krylov_proj] = priv_exponential_Krylov_projected(linsys,RV_0,options,0);
