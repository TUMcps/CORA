function [R,R_Krylov] = priv_exponential_Krylov_projected(linsys,R0,options,stateFlag)
% priv_exponential_Krylov_projected - computes the overapproximation of the 
%    exponential of a system matrix up to a certain accuracy using a Krylov 
%    subspace; the subspace is already precomputed
%
% Syntax:
%    [R,R_Krylov] = priv_exponential_Krylov_projected(linsys,R0,options,stateFlag)
%
% Inputs:
