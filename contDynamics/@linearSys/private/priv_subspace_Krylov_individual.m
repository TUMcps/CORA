function [V,H,krylovOrder] = priv_subspace_Krylov_individual(A,nu_A,v,initKrylovOrder,options)
% priv_subspace_Krylov_individual - computes the Krylov subspace for a single
...
%
% Syntax:
%    [V,H,krylovOrder] = priv_subspace_Krylov_individual(A,nu_A,v,initKrylovOrder,options)
%
% Inputs:
%    A - system matrix
