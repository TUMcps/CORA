function res = test_kleeneSignal_and
% test_kleeneSignal_and - unit test function of and
%
% Syntax:
%    res = test_kleeneSignal_and
%
% Inputs:
%    -
%
...
test_cases{end}.rhs = kleeneSignal.indicator(stlInterval(3,5,false,true),uu,tt);
falseInt = stlInterval(2,4);
unkInt = stlInterval(2,4).toRight() & stlInterval(3,5,false,true);
test_cases{end}.expected = {
    [falseInt.toLeft(),unkInt.toRight()];
    unkInt;
    falseInt;
};
