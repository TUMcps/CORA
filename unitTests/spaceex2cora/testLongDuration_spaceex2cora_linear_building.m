function pass = testLongDuration_spaceex2cora_linear_building()
% testLongDuration_spaceex2cora_linear_building - example of linear reachability 
% analysis from the ARCH17 friendly competition (building example)
%
% Syntax:  
%    testLongDuration_spaceex2cora_linear_building
%
% Inputs:
%    no
%
