function res = testLongDuration_stl_modelCheckReachSet()
% testLongDuration_stl_modelCheckReachSet - unit test function of
%    modelCheckReachSet
%
% Syntax:  
%    res = testLongDuration_stl_modelCheckReachSet
%
% Inputs:
%    -
%
