function res = test_trajectory_plotTimeStep
% test_trajectory_plotTimeStep - unit test function for plotTimeStep
%
% Syntax:
%    res = test_trajectory_plotTimeStep()
%
% Inputs:
%    -
%
...
% empty trajectory
traj = trajectory();
assertThrowsAs(@plotTimeStep,'MATLAB:badsubscript',traj);
