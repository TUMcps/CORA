...
% check equality of time vector
assert(compareMatrices(simRes_.t{1},t{2}) ...
    && compareMatrices(simRes_.t{2},t{4}));

% check equality of state vector
assert(compareMatrices(simRes_.x{1}',x{2}') ...
