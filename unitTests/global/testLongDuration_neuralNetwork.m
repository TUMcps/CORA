function res = testLongDuration_neuralNetwork()
% testLongDuration_neuralNetwork - unit test function for the
%                                  neuralNetworkOld class
%
% Syntax:  
%    res = testLongDuration_neuralNetwork()
%
% Inputs:
%    -
%
