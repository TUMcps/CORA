function res = testLongDuration_interval_projVertices
% testLongDuration_interval_projVertices - unit test function for
%    computation of vertices of a 2D projection
%
% Syntax:  
%    res = testLongDuration_interval_projVertices
%
% Inputs:
%    -
%
