function res = testLongDuration_interval_cartProd
% testLongDuration_interval_cartProd - unit test function of Cartesian
%    product for intervals
%
% Syntax:  
%    res = testLongDuration_interval_cartProd
%
% Inputs:
%    -
%
