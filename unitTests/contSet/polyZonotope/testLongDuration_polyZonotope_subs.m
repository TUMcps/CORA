function res = testLongDuration_polyZonotope_subs
% testLongDuration_polyZonotope_subs - unit test function for composition
%
% Syntax:  
%    res = testLongDuration_polyZonotope_subs
%
% Inputs:
%    -
%
