function res = test_polyZonotope_enclose
% test_polyZonotope_enclose - unit test function for convex-hull computation
%                             of polynomial zonotopes
%
% Syntax:  
%    res = test_polyZonotope_enclose
%
% Inputs:
%    -
%
...
for i = 1:5
    ...
    points = pointSet(pZ1,N);
    pointsExt = pointSetExtreme(pZ1);
...
%     plot(points(1,:),points(2,:),'.k');
    ...
    if ~suc
       error('test_polyZonotope_enclose: random test 2D failed!'); 
    end
end
...
for i = 1:5
    ...
    if ~suc
       error('test_polyZonotope_enclose: random test 4D failed!'); 
    end
end
