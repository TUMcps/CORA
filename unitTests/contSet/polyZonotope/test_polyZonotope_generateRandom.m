...
res(end+1,1) = dim(pZ) == n && size(pZ.expMat,1) == nrFac;
...
res(end+1,1) = dim(pZ) == n && size(pZ.Grest,2) == nrIndGens;
...
res(end+1,1) = dim(pZ) == n && size(pZ.expMat,1) == nrFac && size(pZ.Grest,2) == nrIndGens;
