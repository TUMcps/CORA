function res = testLong_component_ellipsoid_distanceMptPolytope
% testLong_component_ellipsoid_distanceMptPolytope - unit test
%    function of distanceMptPolytope
%
% Syntax:  
%    res = testLong_component_ellipsoid_distanceMptPolytope
%
% Inputs:
%    -
%
