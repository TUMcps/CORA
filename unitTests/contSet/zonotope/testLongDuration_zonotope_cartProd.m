function res = testLongDuration_zonotope_cartProd
% testLongDuration_zonotope_cartProd - unit test function of Cartesian
%    product
%
% Syntax:  
%    res = testLongDuration_zonotope_cartProd
%
% Inputs:
%    -
%
