function res = test_bernsteinPoly(~)
% test_test_bernsteinPoly - unit-test that tests for the conversion of a
%                           polynomial to a bernstein polynomial as 
%                           implemented by the function "poly2bernstein"
%
% Syntax:  
%    res = test_bernsteinPoly( ~ )
%
% Inputs:
%    no
%
       ...
       for i = 1:M
           ...
           for j = 1:M
              ...
              if abs(val-val_) > 1e-13
                 error('Unit-test "test_bernsteinPoly" failed!'); 
              end
           end
       end
    end
