function res = test_spaceex2cora_hybrid_flat_05
% test_spaceex2cora_hybrid_flat_05 - test for model conversion from SpaceEx
%    to CORA for a simple hybrid system with two locations
%
% Syntax:
%    test_spaceex2cora_hybrid_flat_05
%
% Inputs:
%    -
%
