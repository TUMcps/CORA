function res = test_spaceex2cora_hybrid_flat_01
% test_spaceex2cora_hybrid_flat_01 - test for model conversion from SpaceEx
...
filename = 'test_hybrid_flat_oneloc1';
...
% flow equation
dynamics = linearSys([-2 1;1 -2],[0;0]);
