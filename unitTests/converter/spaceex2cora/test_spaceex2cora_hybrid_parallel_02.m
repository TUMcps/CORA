function res = test_spaceex2cora_hybrid_parallel_02
% test_spaceex2cora_hybrid_parallel_02 - test for model conversion from
%    SpaceEx to CORA for a simple parallel hybrid automaton with two
%    components with all-nonlinear behavior
%
% Syntax:
%    test_spaceex2cora_hybrid_parallel_02
%
% Inputs:
%    -
%
