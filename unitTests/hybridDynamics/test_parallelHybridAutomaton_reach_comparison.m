function res = test_parallelHybridAutomaton_reach_comparison
% test_parallelHybridAutomaton_reach_comparison - unit test function which
%    compares the reachable set for a parallel hybrid automaton with the
%    one of the corresponding flat hybrid automaton using the room heating 
%    benchmark described in Sec. 2.3 in [1] with two rooms
%
% Syntax:  
%    res = test_parallelHybridAutomaton_reach_comparison
%
% Inputs:
%    -
%
