function res = test_parallelHybridAutomaton_mergeFlows_03
% test_parallelHybridAutomaton_mergeFlows_03 - test function for merging
%    flow equations in the location product; mixed linear/nonlinear flow
%
% Syntax:  
%    res = test_parallelHybridAutomaton_mergeFlows_03
%
% Inputs:
%    -
%
...
% compare solutions
if ~isequal(mergedFlow,mergedFlow_,1e-14)
    res = false;
end
