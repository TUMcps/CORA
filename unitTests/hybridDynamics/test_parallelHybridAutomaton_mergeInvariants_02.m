function res = test_parallelHybridAutomaton_mergeInvariants_02
% test_parallelHybridAutomaton_mergeInvariants_02 - test function for
%    merging invariant sets (level sets) in the location product
%
% Syntax:  
%    res = test_parallelHybridAutomaton_mergeInvariants_02
%
% Inputs:
%    -
%
...
% compare solutions
if ~isequal(mergedInv,mergedInv_,1e-14)
    res = false;
end
