function res = test_parallelHybridAutomaton_mergeFlows_02
% test_parallelHybridAutomaton_mergeFlows_02 - test function for merging
%    flow equations in the location product; all flow equations are
%    nonlinear
%
% Syntax:  
%    res = test_parallelHybridAutomaton_mergeFlows_02
%
% Inputs:
%    -
%
