function res = testnn_nnReLULayer_evalutateIntervalBatch()
% testnn_nnReLULayer_evalutateIntervalBatch - test 
% nnReLULayer/evaluate with a batch of intervals 
%
% Syntax:
%    res = testnn_nnReLULayer_evalutateIntervalBatch()
%
% Inputs:
%    -
%
