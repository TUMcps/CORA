function res = testnn_nnConvTranspose2DLayer_evalutateIntervalBatch()
% testnn_nnConvTranspose2DLayer_evalutateIntervalBatch - test 
% nnConvTranspose2DLayer/evaluate with a batch of intervals 
%
% Syntax:
%    res = testnn_nnConvTranspose2DLayer_evalutateIntervalBatch()
%
% Inputs:
%    -
%
