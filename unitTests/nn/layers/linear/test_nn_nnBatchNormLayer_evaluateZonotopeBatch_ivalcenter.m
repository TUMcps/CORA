function res = test_nn_nnBatchNormLayer_evaluateZonotopeBatch_ivalcenter()
% test_nn_nnBatchNormLayer_evaluateZonotopeBatch_ivalcenter - test 
% nnBatchNormLayer/evaluateZonotopeBatch function with interval center
%
% Syntax:
%    res = test_nn_nnBatchNormLayer_evaluateZonotopeBatch_ivalcenter()
%
% Inputs:
%    -
%
...
cx = sort(rand([prod(inSize) 2 bSz]),2);
