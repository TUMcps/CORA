function res = test_nn_nnLinearLayer_evaluateIntervalBatch()
% test_nn_nnLinearLayer_evaluateIntervalBatch - test 
% nnLinearLayer/evaluate with a batch of intervals 
%
% Syntax:
%    res = test_nn_nnLinearLayer_evaluateIntervalBatch()
%
% Inputs:
%    -
%
