function res = testnn_nnConv2DLayer_evaluateIntervalBatch()
% testnn_nnConv2DLayer_evaluateIntervalBatch - test 
% nnConv2DLayer/evaluate with a batch of intervals 
%
% Syntax:
%    res = testnn_nnConv2DLayer_evaluateIntervalBatch()
%
% Inputs:
%    -
%
