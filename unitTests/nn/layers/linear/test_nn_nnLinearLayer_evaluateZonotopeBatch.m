function res = test_nn_nnLinearLayer_evaluateZonotopeBatch()
% test_nn_nnLinearLayer_evaluateZonotopeBatch - test 
% nnLinearLayer/evaluateZonotopeBatch function
%
% Syntax:
%    res = test_nn_nnLinearLayer_evaluateZonotopeBatch()
%
% Inputs:
%    -
%
