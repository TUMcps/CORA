function res = testnn_nnLinearLayer_evalutateZonotopeBatch()
% testnn_nnLinearLayer_evalutateZonotopeBatch - test 
% nnLinearLayer/evalutateZonotopeBatch function
%
% Syntax:
%    res = testnn_nnLinearLayer_evalutateZonotopeBatch()
%
% Inputs:
%    -
%
