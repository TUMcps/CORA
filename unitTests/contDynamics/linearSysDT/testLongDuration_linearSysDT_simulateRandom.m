function res = testLongDuration_linearSysDT_simulateRandom
% testLongDuration_linearSysDT_simulateRandom - unit test for simulateRandom
%
% Syntax:  
%    res = testLongDuration_linearSysDT_simulateRandom
%
% Inputs:
%    -
%
