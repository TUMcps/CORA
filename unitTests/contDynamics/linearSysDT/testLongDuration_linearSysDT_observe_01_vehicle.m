function res = testLongDuration_linearSysDT_observe_01_vehicle()
% testLongDuration_linearSysDT_observe_01_vehicle - unit_test_function for guaranteed
...
%
% Syntax:  
%    res = testLongDuration_linearSysDT_observe_01_vehicle()
%
% Inputs:
%    -
%
