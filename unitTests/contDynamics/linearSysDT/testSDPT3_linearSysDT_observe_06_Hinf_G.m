function res = testSDPT3_linearSysDT_observe_06_Hinf_G()
% testSDPT3_linearSysDT_observe_06_Hinf_G - unit_test_function for 
% guaranteed state estimation of linear discrete-time systems using the 
% Hinf-G method and the SDPT3 solver (version 4.0).
%
...
%
% Syntax:
%    res = testSDPT3_linearSysDT_observe_06_Hinf_G
%
% Inputs:
%    -
%
