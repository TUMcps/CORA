function res = test_linearARX_createTestSuite
% test_linearARX_createTestSuite test for creating
%   trajectories for linearARX
%
% Syntax:
%    res = test_linearARX_createTestSuite
%
% Inputs:
%    -
%
