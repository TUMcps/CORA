function res = testLongDuration_linParamSys_F
% testLongDuration_linParamSys_F - underapproximate expm(A) and F for an interval matrix using
% sampling; check if samples are contained in over-approximation.
%
% Syntax:
%    res = testLongDuration_linParamSys_F
%
% Inputs:
%    -
%
% Outputs:
%    res - boolean if successfully completed
%
