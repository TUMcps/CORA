function completed = test_nonlinearParam_reach_04_vanderPol_linearRemainder()
...
options.paramInt=interval([0.995;1],[1;1.005]); %parameter intervals for reachability analysis
