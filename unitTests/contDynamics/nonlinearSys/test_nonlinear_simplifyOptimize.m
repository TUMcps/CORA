function res = test_nonlinear_simplifyOptimize()
% test_nonlinear_simplifyOptimize - unit_test_function for the creation of
%                                   tensors with setting options.simplify =
%                                   'optimize'
%
...
%
% Syntax:  
%    res = test_nonlinear_simplifyOptimize()
%
% Inputs:
%    no
%
