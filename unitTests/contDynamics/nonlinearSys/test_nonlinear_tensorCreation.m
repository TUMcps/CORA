function res = test_nonlinear_tensorCreation()
% test_nonlinear_tensorCreation - unit_test_function for the creation of
...
%
% Syntax:  
%    res = test_nonlinear_tensorCreation()
%
% Inputs:
%    -
%
        ...
        for k = 1:2
            for h = 1:2
                for m = 1:2
                    ...
                    % parallel execution
                    if j == 1
                        options_.lagrangeRem.tensorParallel = 1;
                    end
