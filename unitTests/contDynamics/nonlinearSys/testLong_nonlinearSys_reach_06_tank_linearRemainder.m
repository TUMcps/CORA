function res = testLong_nonlinearSys_reach_06_tank_linearRemainder
% testLong_nonlinearSys_reach_06_tank_linearRemainder - example of
%    nonlinear reachability  analysis;
%
% This example can be found in [1, Sec. 3.4.5] or in [2].
%
% Syntax:
%    res = testLong_nonlinearSys_reach_06_tank_linearRemainder
%
% Inputs:
%    -
%
