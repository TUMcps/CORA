...
options.R0=zonotope([[2; 4; 4; 2; 10; 4],0.2*eye(dim_x)]); %initial state for reachability analysis
...
% check options
options = checkOptionsReach(tank,options);
