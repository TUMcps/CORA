function res = testLongDuration_linearSys_generateRandom
% testLongDuration_linearSys_generateRandom - unit test for random
%    generation of linear systems
%
% Syntax:  
%    res = testLongDuration_linearSys_generateRandom
%
% Inputs:
%    -
%
