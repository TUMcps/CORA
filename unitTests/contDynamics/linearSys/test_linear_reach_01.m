function res = test_linear_reach_01
% test_linear_reach_01 - unit_test_function of linear reachability analysis
%
% Checks the solution of the linearSys class for a small example
% with constant input against the analytical solution
%
% Syntax:  
%    res = test_linear_reach_01
%
% Inputs:
%    no
%
...
% check options
options = checkOptionsReach(linSys,options);
