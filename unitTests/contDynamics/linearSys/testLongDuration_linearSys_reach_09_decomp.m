function res = testLongDuration_linearSys_reach_09_decomp()
% testLongDuration_linearSys_reach_09_decomp - unitTest for the decomposed reachability
%    algorithm from [1], compared to standard reach
%Sys
% Syntax:  
%    res = testLongDuration_linearSys_reach_09_decomp
%
% Inputs:
%    no
%
