function res = test_Krylov_homogeneousSolution_precise(~)
% test_Krylov_homogeneousSolution_precise - unit_test_function for checking
%    the Krylov method for the homegeneous solution of an initial set when
%    precise results are required
%
% Syntax:  
%    res = test_Krylov_homogeneousSolution_precise(~)
%
% Inputs:
%    no
%
