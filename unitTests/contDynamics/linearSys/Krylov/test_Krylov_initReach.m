function res = test_Krylov_initReach(~)
% test_Krylov_initReach - unit_test_function for checking
%    the Krylov method for the solution of the first time interval
%
% Syntax:  
%    res = test_Krylov_initReach(~)
%
% Inputs:
%    no
%
...
% input matrix
B = [...
  -0.852629256418832  -0.035002834783068; ...
   0.058552924933201  -1.513702930337509; ...
  -0.182166613411035  -0.520795317267783; ...
   0.765417983701924  -1.685810079588873; ...
   0.452061312873048   0.637414694783665; ...
   0.274586056684255   0.617417254394296; ...
  -0.384334810712758   0.222095170956017; ...
  -0.413437658430989   0.365907376826282; ...
   0.081875609057807   0.141772462210035; ...
  -0.450467499483832  -0.726188683399945];

% output matrix
C = [ ...
  -0.743412724109282   0.177090169143689   0.460572827606158   0.271647096180747   0.171362502544265   0.146163106567951  -0.535499561823769  -1.104159392184333  -1.188678525548428  -1.306086095170667; ...
   0.349071473346308  -0.714267784326402   0.350146208595565  -1.316107485419179   0.816299675111281  -1.349731746391230  -0.808988705203049   0.386068510764630  -0.553526751787547  -1.499334516081781; ...
  -0.215523509878270  -0.605528138693812  -0.303507495046523   0.503957063126469  -0.056380333343831  -0.376091012556692  -1.097143908361592  -0.134977033230918  -0.290079043585502  -0.041504015450377];
...
options.U = zonotope([0 0.2 -0.3; 0 0.5 1]);
options.uTrans = [1;-2];
...
linDyn = linearSys('KrylovTest',A,B,[],C); %initialize quadratic dynamics
%--------------------------------------------------------------------------
...
% check whether solutions of Krylov method enclose those of the standard method
