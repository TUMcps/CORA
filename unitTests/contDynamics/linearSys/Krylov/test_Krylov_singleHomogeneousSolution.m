function res = test_Krylov_singleHomogeneousSolution(~)
% test_Krylov_singleHomogeneousSolution - unit_test_function for checking
%    the Krylov method for the homegeneous solution of a single initial state
%
% Syntax:  
%    res = test_Krylov_singleHomogeneousSolution(~)
%
% Inputs:
%    no
%
