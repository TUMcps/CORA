function res = test_Krylov_linearTimeErrorBound(~)
% test_Krylov_linearTimeErrorBound - unit_test_function for checking
% whether the proposed error bound of the Krylov method is linear in time
% as derived in Appendix B of
% 
% add TAC paper here
%
% Syntax:  
%    res = test_Krylov_linearTimeErrorBound(~)
%
% Inputs:
%    no
%
