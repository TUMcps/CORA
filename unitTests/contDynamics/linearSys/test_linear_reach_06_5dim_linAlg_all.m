function res = test_linear_reach_06_5dim_linAlg_all()
% test_linear_reach_06_5dim_linAlg_all - unit_test_function of linear reachability 
%    analysis with uncertain inputs (toy example),
%    all linear reach algorithms used (except krylov due to system size)
%
%
% Syntax:  
%    res = test_linear_reach_06_5dim_linAlg_all()
%
% Inputs:
%    no
%
