function res = contains(ls,S,varargin)
% contains - determines if a level set contains a set or a point
%
% Syntax:  
%    res = contains(ls,S)
%    res = contains(ls,S,tol)
%
% Inputs:
%    ls - levelSet object
...
%
% See also: halfspace/contains, conHyperplane/contains
...
% pre-processing
[res,vars] = pre_contains('levelSet',ls,S,varargin{:});
