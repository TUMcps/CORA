function res = and(cPZ,S)
% and - Computes the intersection of a constrained polynomial zonotope and
...
% pre-processing
[resFound,vars] = pre_and('conPolyZono',cPZ,S);
...
elseif isa(S, 'halfspace')
    ...
    % compute lower bound
    l = supportFunc(cPZ,S.c,'lower','interval');
