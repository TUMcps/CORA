function res = contains(cPZ,S,varargin)
% contains - determines if a constrained polynomial zonotope contains a set
%    or a point
%
% Syntax:  
%    res = contains(cPZ,S)
%    res = contains(cPZ,S,type)
%
% Inputs:
...
% pre-processing
[res,vars] = pre_contains('conPolyZono',cPZ,S,varargin{:});
