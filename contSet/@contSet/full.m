function S_out = full(S)
% full - converts all numeric properties of a set to full
%
% Syntax:
%    S_out = full(S)
%
...
%
% Outputs:
%    S_out - contSet object with all numeric properties converted to full
%
% Example:
%    Z = zonotope(sparse([1;0]),sparse([1 0 -1; 0 1 1]));
%    Z_full = full(Z);
%
