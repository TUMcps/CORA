function pZ = priv_restructureReducePart(pZ, order, method)
% priv_restructureReducePart - Calculate a new representation of a
%    polynomial zonotope through partial reduction of the independent
%    generators
%
% Syntax:
%    res = priv_restructureReducePart(pZ, order, method)
%
% Inputs:
