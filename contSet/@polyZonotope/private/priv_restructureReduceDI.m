function pZ = priv_restructureReduceDI(pZ, dfOrder, method, varargin)
% priv_restructureReduceDI - Calculate a new representation of a polynomial
%    zonotope through simultanious reduction of dependent and independent
%    generators
%
% Syntax:
%    pZ = priv_restructureReduceDI(pZ, order, method)
%    pZ = priv_restructureReduceDI(pZ, order, method, genOrder)
%
% Inputs:
...
% ------------------------------ BEGIN CODE -------------------------------
    ...
    elseif d>dfOrder*n
        ...
        throw(CORAerror('CORA:specialError',...
            'Bug in priv_restructureReduceDI: Check logic!'));
    end
end
