...
%
% Example:
%    Z = zonotope(zeros(2,1), [ 0.059 0.718 -0.364 0.504 -0.781 0.049 0.421 -0.417 0.823 -0.489 0.677 0.896 0.169 0.655 -0.115 0.653 -0.585 -0.732 0.142 -0.705 ; 0.660 0.578 -0.096 -0.780 -0.460 0.945 -0.376 0.701 0.279 -0.823 0.169 -0.878 -0.430 -0.618 -0.213 0.354 -0.364 0.343 -0.660 -0.048 ]);
%    dH = dH2box(Z,'naive');
%
% References:
