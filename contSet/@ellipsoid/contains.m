function res = contains(E,S,varargin)
% contains - determines if an ellipsoid contains a set or a point
%
% Syntax:  
%    res = contains(E,S)
%    res = contains(E,S,mode)
%
% Inputs:
%    E - ellipsoid object 
...
% pre-processing
[resFound,vars] = pre_contains('ellipsoid',E,S,varargin{:});
