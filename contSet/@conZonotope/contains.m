function res = contains(cZ,S,varargin)
% contains - determines if a constrained zonotope contains a set or a point
%
% Syntax:  
%    res = contains(cZ,S)
%    res = contains(cZ,S,type)
%    res = contains(cZ,S,type,tol)
%
% Inputs:
...
%------------- BEGIN CODE --------------
    ...
    % pre-processing
    [res,vars] = pre_contains('conZonotope',cZ,S,varargin{:});
    ...
    if res
        ...
        cZ = vars{1}; S = vars{2}; type = vars{3}; tol = vars{4};
    end
