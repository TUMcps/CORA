function res = ne(nonlinReset1,nonlinReset2,varargin)
% ne - checks if two nonlinear reset functions, or a nonlinear reset
%    function and a linear reset function, are equal up to some tolerance
%
% Syntax:
%    res = nonlinReset1 ~= nonlinReset2
%    res = ne(nonlinReset1,nonlinReset2)
%    res = ne(nonlinReset1,nonlinReset2,tol)
%
% Inputs:
