function res = eq(linReset1,linReset2,varargin)
% eq - checks if two linear reset functions are equal up to some tolerance
%
% Syntax:
%    res = linReset == linReset2
%    res = eq(linReset1,linReset2)
%    res = eq(linReset1,linReset2,tol)
%
% Inputs:
