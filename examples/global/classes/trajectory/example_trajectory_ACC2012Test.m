function res = example_trajectory_ACC2012Test()
% example_trajectory_ACC2012Test - Creates test cases (see Def. 7 in [1])
% for the conformance checking procedure in [2].
%
% Syntax:
%    obj = example_trajectory_ACC2012Test()
%
% Inputs:
%    -
%
...
for iCase = 1:3
    ...
    xStep = zeros(size(params.x0,1),inputChanges+1);
    xStep(:,1) = params.x0;
    ...
    % save in test suite
    ACC2012Test(iCase) = trajectory(uVec, xStep, xStep, [], params.timeStep, [], [], name, model); % measurement equals state in these test cases
end
