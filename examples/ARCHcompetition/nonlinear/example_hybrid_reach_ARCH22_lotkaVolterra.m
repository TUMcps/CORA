function text = example_hybrid_reach_ARCH22_lotkaVolterra()
% example_hybrid_reach_ARCH22_lotkaVolterra - hybrid Lotka-Volterra
%    benchmark from the 2022 ARCH competition
%
% Syntax:  
...
res = true;
% text for .csv
text = ['CORA,LOVO22, ,',num2str(res),',',num2str(tComp),',',num2str(area)];
