function res = example_linear_reach_ARCH22_building_BLDF01()
% example_linear_reach_ARCH22_building_BLDF01 - building benchmark from the
%    ARCH 2022 competition (time-varying inputs)
%
% Syntax:  
%    res = example_linear_reach_ARCH22_building_BLDF01()
%
% Inputs:
%    -
%
