function text = benchmark_linearParam_reach_ARCH23_platoon_PLAA01_BND50()
% benchmark_linearParam_reach_ARCH23_platoon_PLAA01_BND50 - example of linear 
...
text = ['Platoon,PLAA01-BND50,',num2str(~violation50),',',num2str(tVer + tComp)];
