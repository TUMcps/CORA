function text = benchmark_hybrid_reach_ARCH23_powerTrain_DTN01()
% benchmark_hybrid_reach_ARCH23_powerTrain_DTN01 - powertrain example 
%    (see [1]) from the 2023 ARCH competition Test case DTN01)
% 
%
% Syntax:
...
% example completed
text = ['Powertrain,DTN01,',num2str(res1&res2),',',num2str(tComp1+tComp2)];
