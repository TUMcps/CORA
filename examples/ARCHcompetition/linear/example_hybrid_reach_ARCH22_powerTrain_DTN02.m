function completed = example_hybrid_reach_ARCH22_powerTrain_DTN02()
% example_hybrid_reach_ARCH22_powerTrain_DTN02 - powertrain example 
%    (see [1]) from the 2022 ARCH competition (Test case DTN02)
% 
%
% Syntax:  
%    example_hybrid_reach_ARCH22_powerTrain_DTN02()
%
% Inputs:
%    -
%
