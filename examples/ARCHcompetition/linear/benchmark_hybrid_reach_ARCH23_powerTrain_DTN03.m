function text = benchmark_hybrid_reach_ARCH23_powerTrain_DTN03()
% benchmark_hybrid_reach_ARCH23_powerTrain_DTN03 - powertrain example 
%    (see [1]) from the 2023 ARCH competition (Test case DTN03)
% 
% Syntax:
...
% example completed
text = ['Powertrain,DTN03,',num2str(res1&res2),',',num2str(tComp1+tComp2)];
