function res = example_linear_reach_ARCH22_building_BLDC01()
% example_linear_reach_ARCH22_building_BLDC01 - building benchmark from
%    the 2022 ARCH competition (constant inputs)
%
% Syntax:  
