function res = example_linear_reach_ARCH22_beam_CB01()
% example_linear_reach_ARCH22_beam_CB01 - clamped beam benchmark
...
tComp_C = toc(timer);
disp(['computation time (CB01C_' num2str(N) '): ' num2str(tComp_C)]);
...
tComp_F = toc(timer);
disp(['computation time (CB01F_' num2str(N) '): ' num2str(tComp_F)]);
...
% requirement: velocity at node 70/100
projDim = node * 2;
