function res = example_linear_reach_ARCH21_iss_ISSF01_ISS01()
% example_linear_reach_ARCH21_iss_ISSF01_ISS01 - ISS benchmark from ARCH21
%    solved with Alg. from [1] (time-varying input)
%
% Syntax:  
%    res = example_linear_reach_ARCH21_iss_ISSF01_ISS01()
%
% Inputs:
%    no
%
...
hs1 = halfspace([0, 0, 1], -7e-4); 
hs2 = halfspace([0, 0, -1], -7e-4);
