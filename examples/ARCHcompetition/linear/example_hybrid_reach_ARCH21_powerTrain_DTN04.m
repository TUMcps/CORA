function completed = example_hybrid_reach_ARCH21_powerTrain_DTN04()
% example_hybrid_reach_ARCH21_powerTrain_DTN04 - powertrain example 
%    (see [1]) from the 2020 ARCH competition (Test case DTN04)
% 
%
% Syntax:  
%    example_hybrid_reach_ARCH20_powerTrain_DTN04()
%
% Inputs:
%    no
%
...
% plot reachable set
plot(R,[1,3],'FaceColor',[.6 .6 .6],'Filled',true,'EdgeColor','none');
