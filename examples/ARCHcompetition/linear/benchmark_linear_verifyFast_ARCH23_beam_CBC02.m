function text = benchmark_linear_verifyFast_ARCH23_beam_CBC02
% benchmark_linear_verifyFast_ARCH23_beam_CBC02 - beam benchmark from the
%     2023 ARCH competition
%
% Syntax:
%    text = benchmark_linear_verifyFast_ARCH23_beam_CBC02()
%
% Inputs:
%    -
%
...
text = ['Beam,CBC02,',num2str(res),',',num2str(savedata.tComp)];
