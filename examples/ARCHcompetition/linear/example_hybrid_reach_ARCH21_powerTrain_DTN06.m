function completed = example_hybrid_reach_ARCH21_powerTrain_DTN06()
% example_hybrid_reach_ARCH21_powerTrain_DTN06 - powertrain example 
%    (see [1]) from the 2021 ARCH competition (Test case DTN06)
% 
%
% Syntax:  
