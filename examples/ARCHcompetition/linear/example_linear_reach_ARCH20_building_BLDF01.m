function res = example_linear_reach_ARCH20_building_BLDF01()
% example_linear_reach_ARCH20_building_BLDF01 - building benchmark from the
%                                               ARCH 2020 competition
%                                               (time-varying input)
%
% Syntax:  
%    res = example_linear_reach_ARCH20_building_BLDF01()
%
% Inputs:
%    no
%
