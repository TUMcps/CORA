...
% models_MATPOWER_steadyStateNotFound = {'case24_ieee_rts', 'case39', 'case118', 'case145', 'case16am', 'case16ci', 'case70da'};

% set path
path = [CORAROOT filesep 'converter' filesep 'powerSystem2cora' filesep 'cases'];
path_CORAmodel = [CORAROOT filesep 'models' filesep 'Cora' filesep 'powerSystems'];
path_spec = [CORAROOT filesep 'converter' filesep 'powerSystem2cora' filesep 'specs'];
