function completed = example_nonlinearSysDT_conform_01_white
% example_nonlinearSysDT_conform_01_white - example for conformance 
...
n_k = 6; % length of the identification trajectories
