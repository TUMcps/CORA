...
level = cell(length(simRes.x),1);
for iRun = 1:length(simRes.x)
    level{iRun} = -4.7523e-04*simRes.x{iRun}(:,1) + ...
        6.8027e+01*simRes.x{iRun}(:,2) + ...
        6.8027e+01*simRes.x{iRun}(:,4) + ...
        1.9778e+04*simRes.x{iRun}(:,3) - 1.4778e3;
end 
