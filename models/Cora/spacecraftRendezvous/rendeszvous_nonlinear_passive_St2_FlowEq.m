function dx = rendeszvous_nonlinear_passive_St2_FlowEq(x,u)
% rendeszvous_nonlinear_passive_St2_FlowEq - system dynamics for mode 2 for
%                                            the spacecraft rendevous 
%                                            benchmark described in [1] 
%
% Syntax:  
%    dx = rendeszvous_nonlinear_passive_St2_FlowEq(x,u)
%
% Inputs:
%    x - state vector
%    u - input vector
