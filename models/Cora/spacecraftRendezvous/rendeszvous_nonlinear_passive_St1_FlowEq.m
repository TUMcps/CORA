function dx = rendeszvous_nonlinear_passive_St1_FlowEq(x,u)
% rendeszvous_nonlinear_passive_St1_FlowEq - system dynamics for mode 1 for
%                                            the spacecraft rendevous 
%                                            benchmark described in [1] 
%
% Syntax:  
%    dx = rendeszvous_nonlinear_passive_St1_FlowEq(x,u)
%
% Inputs:
%    x - state vector
%    u - input vector
