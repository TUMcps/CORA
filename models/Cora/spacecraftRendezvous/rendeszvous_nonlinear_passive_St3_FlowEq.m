function dx = rendeszvous_nonlinear_passive_St3_FlowEq(x,u)
% rendeszvous_nonlinear_passive_St3_FlowEq - system dynamics for mode 3 for
%                                            the spacecraft rendevous 
%                                            benchmark described in [1] 
%
% Syntax:  
%    dx = rendeszvous_nonlinear_passive_St3_FlowEq(x,u)
%
% Inputs:
%    x - state vector
%    u - input vector
