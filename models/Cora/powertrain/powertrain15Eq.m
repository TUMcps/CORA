function f = powertrain15Eq(x,u,p)
% powertrain15Eq - dynamic for the 15-dimensional power train system 
%                 (see Sec. 6 in [1])
%
% Syntax:  
...
f(5,1) = x(6); %Theta_l
f(6,1) = 1/p.J_l*(p.k_i*(x(14) - x(5)) - u(2) - p.b_l*x(6)); %\dot{Theta}_l
...
f(14,1) = x(15); %Theta_4
f(15,1) = p.J_i*(p.k_i*(x(12) - x(14)) - p.k_i*(x(14) - x(5)) - p.b_i*x(15)); %\dot{Theta}_4
