function f = powertrain51Eq(x,u,p)
...
f(5,1) = x(6); %Theta_l
f(6,1) = 1/p.J_l*(p.k_i*(x(50) - x(5)) - u(2) - p.b_l*x(6)); %\dot{Theta}_l
...
f(43,1) = p.J_i*(p.k_i*(x(40) - x(42)) - p.k_i*(x(42) - x(44)) - p.b_i*x(43)); %\dot{Theta}_13
f(44,1) = x(45); %Theta_19
f(45,1) = p.J_i*(p.k_i*(x(42) - x(44)) - p.k_i*(x(44) - x(46)) - p.b_i*x(45)); %\dot{Theta}_14
f(46,1) = x(47); %Theta_20
f(47,1) = p.J_i*(p.k_i*(x(44) - x(46)) - p.k_i*(x(46) - x(48)) - p.b_i*x(47)); %\dot{Theta}_15
f(48,1) = x(49); %Theta_21
f(49,1) = p.J_i*(p.k_i*(x(46) - x(48)) - p.k_i*(x(48) - x(50)) - p.b_i*x(49)); %\dot{Theta}_16
