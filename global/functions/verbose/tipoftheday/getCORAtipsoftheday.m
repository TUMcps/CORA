...
function tips = aux_getTipsGlobal() % ./global
    tips = {
        ...
        'Consider creating a video of the reachable set evolving over time using the ' aux_addOpenFileText('recordReachableSet') ' function.\n' ...
        ...
        aux_addOpenFileText('CORAtable') 's offer you multiple design options.\n' ...
        aux_addHelpCWText('CORAtable')]
        ['Do you want to contribute to CORA?\n' ...
        'Please follow our ' aux_addLinkText('https://gitlab.lrz.de/cps/cora/-/wikis/home/Coding-conventions','coding conventions') ' to ensure clear and readable code.']
...
function tips = aux_getTipsNN() % ./nn
    tips = {
        ...
        ['CORA also has the capability to verify graph neural networks.\n' ...
        'To get started, check out the example file ' aux_addOpenFileText('example_gnn_uncertain_message_passing') '.\n'] ...
    };
end
...
function tips = aux_getTipsPlotting() % plotting
    tips = {
        ...
        ['In CORA, you can toggle whether sets should be plotted with face color using the macro ' aux_addOpenFileText('CORA_PLOT_FILLED') '.']
        ...
        'To speed up the process, we unify the sets before plotting.\n' ...
        'See ''Unify'' option for more information.\n' ...
        aux_addHelpCWText({'reachSet/plot', 'reachSet/plotOverTime'})]
        ...
        ['CORA plots sets with edge color and face color with reduced opacity by default.\n' ...
        'You can toggle this behavior with the ' aux_addOpenFileText('CORA_PLOT_FILLED') ' macro.']
    };
end
