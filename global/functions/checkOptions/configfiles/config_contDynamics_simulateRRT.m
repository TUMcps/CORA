function [paramsList,optionsList] = config_contDynamics_simulateRRT(sys,params,options)
% config_contDynamics_simulateRRT - configuration file for validation of
%    model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_contDynamics_simulateRRT(sys,params,options)
%
% Inputs:
...
add2options('strechFac','mandatory',{@isscalar,@isnumeric,@(val)ge(val,1)},{'isscalar','isnumeric','geone'});
