function [paramsList,optionsList] = config_linearSys_priv_verifyRA_zonotope
% config_linearSys_priv_verifyRA_zonotope - configuration file for validation of
%    model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_linearSys_priv_verifyRA_zonotope
%
% Inputs:
%    -
%
