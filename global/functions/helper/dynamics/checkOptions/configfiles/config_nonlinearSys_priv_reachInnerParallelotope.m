function [paramsList,optionsList] = config_nonlinearSys_priv_reachInnerParallelotope
% config_nonlinearSys_priv_reachInnerParallelotope - configuration file for
%    validation of model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_nonlinearSys_priv_reachInnerParallelotope
%
% Inputs:
%    -
%
