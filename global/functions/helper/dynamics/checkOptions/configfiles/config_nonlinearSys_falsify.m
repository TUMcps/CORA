function [paramsList,optionsList] = config_nonlinearSys_falsify
% config_nonlinearSys_falsify - configuration file for validation
%    of model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_nonlinearSys_falsify
%
% Inputs:
%    -
%
