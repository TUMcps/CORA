function [paramsList,optionsList] = config_linearSys_falsify
% config_linearSys_falsify - configuration file for validation
%    of model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_linearSys_falsify
%
% Inputs:
%    -
%
