function [paramsList,optionsList] = config_linearSysDT_falsify
% config_linearSysDT_falsify - configuration file for validation
%    of model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_linearSysDT_falsify
%
% Inputs:
%    -
%
