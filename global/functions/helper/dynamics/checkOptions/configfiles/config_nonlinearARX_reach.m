function [paramsList,optionsList] = config_nonlinearARX_reach
% config_nonlinearARX_reach - configuration file for validation of
%    model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_nonlinearARX_reach
%
% Inputs:
%    -
%
...
% optional
paramsList(end+1,1) = add2list('Y0','optional');
