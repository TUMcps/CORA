function [paramsList,optionsList] = config_nonlinearSys_priv_reachInnerProjection
% config_nonlinearSys_priv_reachInnerProjection - configuration file for
%    validation of model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_nonlinearSys_priv_reachInnerProjection
%
% Inputs:
%    -
%
