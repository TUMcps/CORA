function [paramsList,optionsList] = config_nonlinearSysDT_falsify
% config_nonlinearSysDT_falsify - configuration file for validation
%    of model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_nonlinearSysDT_falsify
%
% Inputs:
%    -
%
