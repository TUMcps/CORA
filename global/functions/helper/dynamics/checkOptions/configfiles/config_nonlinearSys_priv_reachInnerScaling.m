function [paramsList,optionsList] = config_nonlinearSys_priv_reachInnerScaling
% config_nonlinearSys_priv_reachInnerScaling - configuration file for validation
%    of model parameters and algorithm parameters
%
% Syntax:
%    [paramsList,optionsList] = config_nonlinearSys_priv_reachInnerScaling
%
% Inputs:
%    -
%
