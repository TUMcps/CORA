function res = incrementalSingleBranch(R,analyzer,verbose)
% incrementalSingleBranch - incremental STL verification using a reachable set with a single branch
%
% Syntax:
%    res = incrementalSingleBranch(R,phi,verbose)
%
% Inputs:
