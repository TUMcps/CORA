...
methods
    ...
    function obj = specification(varargin)
        ...
        if nargin >= 2
            ...
            %         obj = specification(eq,'logic')
            %         obj = specification(func,'custom')
            [type,loc] = readOutInputArg(varargin{2},2);
        ...
        if nargin >= 3
            ...
            %         obj = specification(func,'custom',location)
            %         obj = specification(func,'custom',time)
            [~,loc,time] = readOutInputArg(varargin{3},3);
        ...
        if nargin == 4
            ...
            [~,loc,time] = readOutInputArg(varargin{4},4);
...
function [type,loc,time] = readOutInputArg(argIn,idx)
