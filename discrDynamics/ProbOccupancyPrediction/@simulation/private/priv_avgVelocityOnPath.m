function [avgVelocity]=priv_avgVelocityOnPath(pTotal,field)
% priv_avgVelocityOnPath - computes the average velocity on path segments
%
% Syntax:
%    [avgVelocity]=priv_avgVelocityOnPath(pTotal,field)
%
% Inputs:
