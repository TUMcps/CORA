function [p,pTotal]=priv_vehicleFollowing(simOptions,markovChainSpec)
% priv_vehicleFollowing - simulates a vehicle that follows another vehicle
%
% Syntax:
%    [p,pTotal]=priv_vehicleFollowing(simOptions,markovChainSpec)
%
% Inputs:
