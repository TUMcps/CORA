function [inputProb] = priv_speedRestriction(simOptions,markovChainSpec)
% priv_speedRestriction - Restricts the speed on roads due to speed limits or
% the road geometry (maximum speed through curves)
%
% Syntax:
%    [inputProb] = priv_speedRestriction(simOptions,markovChainSpec)
%    
%
% Inputs:
