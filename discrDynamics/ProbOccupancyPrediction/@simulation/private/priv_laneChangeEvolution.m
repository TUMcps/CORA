function [lcEvolProb]=priv_laneChangeEvolution(pChange,lcEvolProb,markovChainSpec)
% priv_laneChangeEvolution - updates the probability distribution for the state
...
%
% Syntax:
%    [lcEvolProb]=priv_laneChangeEvolution(pChange,lcEvolProb)
%
% Inputs:
