function [p,pTotal]=priv_autonomousDrivingOptimized(simOptions,markovChainSpec)
% priv_autonomousDrivingOptimized - simulates the autonomous car, based on the 
% autonomous car trajectory
%
% Syntax:
%    [p,pTotal]=priv_autonomousDrivingOptimized(simOptions,markovChainSpec)
%
% Inputs:
