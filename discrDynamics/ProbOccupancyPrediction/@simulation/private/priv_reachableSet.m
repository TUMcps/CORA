function [indices,minPos,maxPos]=priv_reachableSet(simOptions,markovChainSpec)
% priv_reachableSet - computes the non-probabilistic reachable set of the
% vehicle
%
% Syntax:
%    [indices,minPos,maxPos]=priv_reachableSet(simOptions,markovChainSpec)
%
% Inputs:
