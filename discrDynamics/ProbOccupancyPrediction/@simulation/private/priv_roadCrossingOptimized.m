function [p,pTotal]=priv_roadCrossingOptimized(simOptions,markovChainSpec)
% priv_roadCrossingOptimized - simulates a vehicle crossing an intersection that has no
...
%
% Syntax:
%    [p,pTotal]=priv_roadCrossingOptimized(simOptions,markovChainSpec)
%
% Inputs:
...
[pAppr,pApprTotal,pTrans]=priv_drivingOptimized(simOptions,markovChainSpec);  
...
[pCross,pCrossTotal]=priv_drivingOptimized(simOptions,markovChainSpec);   
