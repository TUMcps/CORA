function [T] = priv_roadTransitionCopying(tp,T,field)
% priv_roadTransitionCopying - Copies transitions describing motion of traffic
...
%
% Syntax:
%    [T] = priv_roadTransitionCopying(tp,T,field)
%
% Inputs:
